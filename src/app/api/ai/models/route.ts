...
const MODEL_INFORMATION = {
  openai: [
    { id: 'gpt-5-large', name: 'GPT-5 Large', contextWindow: 512000, maxTokens: 16384, isNew: true },
    { id: 'gpt-5-medium', name: 'GPT-5 Medium', contextWindow: 256000, maxTokens: 16384, isNew: true },
    { id: 'gpt-5-small', name: 'GPT-5 Small', contextWindow: 128000, maxTokens: 8192, isNew: true },
    { id: 'gpt-4o-2024-11-20', name: 'GPT-4o (Nov 2024)', contextWindow: 128000, maxTokens: 16384 },
    ...
    { id: 'gpt-4-turbo', name: 'GPT-4 Turbo', contextWindow: 128000, maxTokens: 4096, isDeprecated: true },
    { id: 'gpt-3.5-turbo', name: 'GPT-3.5 Turbo', contextWindow: 16385, maxTokens: 4096, isDeprecated: true }
  ],
  anthropic: [
    { id: 'claude-4.1-opus', name: 'Claude Opus 4.1', contextWindow: 200000, maxTokens: 8192, isNew: true },
    { id: 'claude-3-5-sonnet-20241022', name: 'Claude 3.5 Sonnet (Oct 2024)', contextWindow: 200000, maxTokens: 8192 },
    { id: 'claude-3-5-sonnet-20240620', name: 'Claude 3.5 Sonnet (Jun 2024)', contextWindow: 200000, maxTokens: 8192 },
  ...
  gemini: [
    { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', contextWindow: 1000000, maxTokens: 8192, isNew: true },
    { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', contextWindow: 2000000, maxTokens: 8192, isNew: true },
  ...
  xai: [
    { id: 'grok-4', name: 'Grok 4', contextWindow: 131072, maxTokens: 4096, isNew: true },
    { id: 'grok-3-beta', name: 'Grok 3 Beta', contextWindow: 131072, maxTokens: 4096 },
    { id: 'grok-3-mini', name: 'Grok 3 Mini', contextWindow: 131072, maxTokens: 4096 }
  ],
  deepseek: [
    { id: 'deepseek-chat', name: 'DeepSeek Chat', contextWindow: 64000, maxTokens: 4096, isNew: true },
    { id: 'deepseek-reasoner', name: 'DeepSeek Reasoner', contextWindow: 64000, maxTokens: 4096, isNew: true }
  ]
};
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Return all models
    const allModels = Object.entries(MODEL_INFORMATION).reduce((acc, [providerKey, models]) => {
      acc[providerKey] = {
        models,
        count: models.length
      };
    ...
    // Calculate totals
    const totalModels = Object.values(MODEL_INFORMATION).reduce((sum, models) => sum + models.length, 0);
    ...
    return NextResponse.json({
      ...
      summary: {
        ...
        deprecatedModels: Object.values(MODEL_INFORMATION)
          .flat()
          .filter(model => 'isDeprecated' in model && model.isDeprecated).length
      },
