...
export function ChatInputComponent({
  ...
  return (
    ...
    >
      {/* Drag overlay */}
      {dragOver && (
        <div className="absolute inset-0 z-10 flex items-center justify-center rounded-lg border-2 border-dashed border-blue-500 bg-blue-500/10">
        ...
        <div className="border-b border-gray-200 px-4 py-2 dark:border-gray-700">
          <div className="flex flex-wrap gap-2">
            {attachments.map((file, index) => (
              <div
                key={`${file.name}-${index}`}
                className="flex items-center gap-2 rounded-lg bg-gray-100 px-3 py-2 text-sm dark:bg-gray-800"
              >
      ...
      <div className="p-4">
        ...
        <div className="relative">
          <BaseChatInput
            ...
            className={cn(
              'pb-12 pr-24', // Extra space for buttons
      ...
      {showEmojiPicker && (
        <div className="absolute bottom-full left-4 z-20 mb-2 rounded-lg border border-gray-200 bg-white p-4 shadow-lg dark:border-gray-700 dark:bg-gray-800">
