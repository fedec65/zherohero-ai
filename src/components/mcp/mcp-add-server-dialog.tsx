...
const availableCapabilities: { id: MCPCapability; label: string; description: string }[] = [
  { id: 'tools', label: 'Tools', description: 'Execute functions and tools' },
  { id: 'resources', label: 'Resources', description: 'Access external resources' },
  { id: 'prompts', label: 'Prompts', description: 'Provide prompt templates' },
  { id: 'logging', label: 'Logging', description: 'Log interactions and events' },
];
...
export function AddMCPServerDialog({ open, onClose }: AddMCPServerDialogProps) {
  ...
  const { addCustomServer, testConnection, validateServerConfig, loading } = useMCPStore();
  ...
  const isFormValid = form.name.trim() && form.url.trim() && form.capabilities.length > 0;
    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && handleClose()}>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="server-url" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Server URL *
            </label>
            <div className="relative">
          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <input
                ...
                onChange={(e) => updateForm({ autoInject: e.target.checked })}
                className="h-4 w-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700"
              />
              <div>
                <div className="text-sm font-medium text-gray-900 dark:text-white">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
          <Button
            ...
            leftIcon={isTesting ? <Loader2 className="h-4 w-4 animate-spin" /> : undefined}
          >
