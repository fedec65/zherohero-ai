    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
        ...
        <p className="text-sm text-blue-800 dark:text-blue-200">
          Your exported data contains your chat history and preferences. API
          keys are never included in exports for security reasons. Keep backup
          files secure and delete them after importing if they contain sensitive
          conversations.
        </p>
      </div>
    </div>
